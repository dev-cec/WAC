...
\begin{itemize}
  ...
  \item \textbf{seulement hachés} : documents et fichiers de données (cible d'un
        raccourci, par exemple). Les copier ferait de la collecte une copie des
...
cibles de raccourcis. Chaque fichier n'est lu qu'une fois, quel que soit le
