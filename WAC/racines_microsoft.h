 ...
 *  verified. */
struct MicrosoftRoot {
    const char* name;           //!< subject (CN)
    const char* sha1Thumbprint; //!< thumbprint, for manual checking
    const uint8_t* der;        //!< the certificate, DER-encoded
    size_t size;             //!< size of `der`, in bytes
};

// Microsoft Root Certificate Authority 2010 — expires 2035-06-24 — Windows: Windows Production PCA 2011
static const uint8_t ROOT_0[1521] = {
...
static const uint8_t ROOT_1[1521] = {
...
static const uint8_t ROOT_2[1437] = {
...
static const uint8_t ROOT_3[1046] = {
...
static const MicrosoftRoot MICROSOFT_ROOTS[] = {
    { "Microsoft Root Certificate Authority 2010", "3B1EFD3A66EA28B16697394703A72CA340A05BD5", ROOT_0, sizeof(ROOT_0) },
    { "Microsoft Root Certificate Authority 2011", "8F43288AD272F3103B6FB1428485EA3014C0BCFE", ROOT_1, sizeof(ROOT_1) },
    { "Microsoft Root Certificate Authority", "CDD4EEAE6000AC7F40C3802C171E30148030C072", ROOT_2, sizeof(ROOT_2) },
    { "Microsoft Root Authority", "A43489159A520F0D93D032CCAF37E7FE20A8B419", ROOT_3, sizeof(ROOT_3) },
};
