...
La dernière version compilée se trouve dans \fichier{WAC/bin} du dépôt :
\fichier{WAC.exe}, le \fichier{wac.yml} de référence et \fichier{SHA256SUMS}
pour les vérifier. Copier \fichier{WAC.exe} et \fichier{wac.yml} sur la clé
de collecte suffit.
