...
mark, empty file), refusals with the right line (duplicate key, list, anchor,
alias, tag, second document, tab, quote left open, nesting too deep), then
3,000 texts damaged at random; seven mutations all detected.
