...
\section{Trust lists: \texttt{inflate\_test}, \texttt{cab\_test}, \texttt{zip\_test}, \texttt{trust\_list\_test}}
...
\begin{itemize}
  ...
  \item \texttt{trust\_list\_test}: the counts of \fichier{authroot.stl} (roots
    ...
    \fichier{disallowedcert.stl}; a list with one byte changed, refused.
\end{itemize}
...
Reference (lists of 25~August~2026 and 5~September~2025): 41 checks, no
...
fingerprints, 217 denied signers, 8,151 LOLDrivers fingerprints.
