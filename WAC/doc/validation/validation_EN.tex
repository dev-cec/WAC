...
\begin{itemize}
  \item 24 valid JSON files out of 24 produced, USBSTOR included: the harness
    attaches a virtual USB key on every cycle, so that a recreated test
    machine knows one too;
  \item 33 cross-checks passed, no failure, among them 4,068 local dates
