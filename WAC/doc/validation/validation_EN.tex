...
\begin{description}[leftmargin=0pt,itemsep=0.5em]
  ...
  \item[The test programs] (chapter~\ref{ch:harnais}): fourteen executables
...
Fourteen executables, left out of \wac{}'s build by their
...
\texttt{system\_conversions\_test} & the Windows functions replaced &
  9,661,288 comparisons, no difference (details below) \\
...
\begin{itemize}
  ...
  \item 29 cross-checks passed, no failure, among them 4,045 local dates
